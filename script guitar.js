...
AnswerList();
await say("Welcome to the Guitar page! Use the left and right arrow keys to scroll through the notes in the scale. Click enter to hear the note name and click the space bar to play the note sound! Press the right arrow to begin.");
